 ...
 */
public class BalancedBinaryTree_History<E> extends BinarySearchTree_History<E> {

    /**
     * 无参构造
     */
    public BalancedBinaryTree_History() {
        this(null);
    }
     ...
     * @param comparator
     */
    public BalancedBinaryTree_History(Comparator<E> comparator) {
        super(comparator);
    }
